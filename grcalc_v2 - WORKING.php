...
<span id="errorstate" style="display:none"><img src="../GR_CALC_v2/Images/redarrow.png" align="middle" /></span></td>
          </tr>
      </table></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="44%" class="style8"><select name="city" style="width:160px;"></select>
<span id="errorcity" style="display:none"><img src="../GR_CALC_v2/Images/redarrow.png" /></span></td>
          </tr>
      </table></td>
      <td>&nbsp;</td>
    </tr>
      ...
      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="44%">
            	...
            	<span id = "areaip" style="">ft<sup>2</sup></span><span id = "areasi" style="display:none">m<sup>2</sup></span> (roof area)<span id="errorarea" style="display:none"><img src="../GR_CALC_v2/Images/redarrow.png" /></span>            </td>
          </tr>
      </table></td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="44%"><input name="soildepth" type="text" id="soildepth" size="2" maxlength="5" title="Growing Media Depth must be a numerical value from 2 to 11.5 inches." value="<?php echo(((isset($_SESSION['soildepth'])) ? $_SESSION['soildepth'] : ''));?>"/>
                <span id = "sdepthip" style=""> inches</span><span id = "sdepthsi" style="display:none">cm</span><span id="errorsdepth" style="display:none"><img src="../GR_CALC_v2/Images/redarrow.png" /></span>            </td>
          </tr>
      </table></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="44%" ><input name="lai" type="text" id="lai" size="2" maxlength="4" title="Leaf Area Index must be a value between 0.5 (sparse vegetation) and 5 (dense vegetation)." value="<?php echo(((isset($_SESSION['lai'])) ? $_SESSION['lai'] : ''));?>"/><span id="errorlai" style="display:none"><img src="../GR_CALC_v2/Images/redarrow.png" /></span></td>
          </tr>
      </table></td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="79%" class="style12">What percentage of your roof does the Green Roof cover? 
            <span class="style13">(1 to 100%)</span></td>
            <td width="21%"><input name="rpercent" type="text" id="rpercent" size="2" maxlength="3" title="Percent of roof covered must be a value between 1 and 100." value="<?php echo(((isset($_SESSION['rpercent'])) ? $_SESSION['rpercent'] : ''));?>" />%<span id="errorpercent" style="display:none"><img src="../GR_CALC_v2/Images/redarrow.png" /></span>            </td>
          </tr>
      </table></td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td colspan="2" ><table style="display:none" id="utilities" width="100%" border="0" cellspacing="0" cellpadding="1">
          <tr>
            <td width="54%" class="style12">Enter electricity price:</td>
            <td width="2%">$</td>
            <td width="44%"><input type="text" name="electricrate" id="electricrate" size="2" maxlength="4" title="Electricity rate must be a numerical value from $.001 to $1.00 per kWh." value="<?php echo(((isset($_SESSION['electricrate'])) ? $_SESSION['electricrate'] : ''));?>" />
                <label> per kWh </label><span id="errorerate" style="display:none"><img src="../GR_CALC_v2/Images/redarrow.png" /></span></td>
          ...
          <tr>
            ...
            <td>$</td>
            <td width="44%"><input type="text" name="gasrate" id="gasrate" size="2" maxlength="4" title="Natural gas effective fixed rate." value="<?php echo(((isset($_SESSION['gasrate'])) ? $_SESSION['gasrate'] : ''));?>"/>
                <label> per Therm (or kWh if SI) </label><span id="errorgrate" style="display:none"><img src="../GR_CALC_v2/Images/redarrow.png" /></span>            </td>        
          </tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td width="27%" align="left" > <div align="right"><br />
